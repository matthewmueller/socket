// Package socket is a parser for accepting more server addresses including unix
...
//go:generate go run github.com/pointlander/peg -strict -switch -inline parse.peg
